    ...
    <div class="user-profile">
      ...
      <div class="profile-details">
        ...
        <div style="display: flex; align-items: center;">
          ...
          <img @click="editProfile" width="25" height="25" src="https://img.icons8.com/ios/100/create-new.png" alt="create-new"/>
        </div>
      </div>
    </div>
    ...
    <div v-if="isImageModalOpen" class="modal">
      <div class="modal-content">
        ...
        <div>
          ...
          <input type="file" id="profile-picture" name="profile-picture" @change="handleFileUpload">
        </div>
...
const deletePhoto = async () => {
  try {
    const storageReference = storageRef(storage, userData.profilePicture);
