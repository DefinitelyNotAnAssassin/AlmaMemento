<template>
  <NavBar />
  <button @click="setCurrentAlbumPage('Grad Main')">Graduation Album</button>
  <button @click="setCurrentAlbumPage('SE Main')">School Events</button>
  ...
  <div v-if="currentAlbumPage === 'SE Main'">
      <SchoolEventMain :currentAlbumPage="currentAlbumPage" @update:currentPage="currentAlbumPage = $event" @folder-name="updateSelectedEventFolder" />
  </div>
  <div v-if="currentAlbumPage === 'School Events'">
      <SchoolEvents :folderName="selectedFolderName"  @update:currentPage="currentAlbumPage = $event" @subfolder-name="updateSelectedEventSubFolder" />
  </div>
</template>
